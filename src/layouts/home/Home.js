      ...
      <main className="container">
        <div className="pure-g">
          <div className="pure-u-1-1">
            <h1>Twit Pool</h1>
            <p>Welcome to our @realDonaldTrump betting pool. Guess what the Donald tweets and get paid.</p>
            <p>Based on Ethereum smart contract technology, this pool doesn't rely on a third party. Smart contract code is auditable.</p>
